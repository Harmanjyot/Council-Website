...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2019 at 06:35 PM
...
('admin', '$2y$10$fa3k.zUirGNcFux0SfjTkeTTMwKCDGfVvjQcwvHPi/hASYa0bxcXm'),
('teacher', '$2y$10$YkZxY74a.Kh6g1j7EzLlTegXTw9Wj4ySoVV6lGy8r64SlmeN2D.gi');
...
(21, 'Electrical', 3, '60', 0, 0),
(22, 'Electrical', 4, '7', 0, 0);
...
--
-- Indexes for table `studentverification`
--
...
--
ALTER TABLE `eventregistrations`
  MODIFY `SrNo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
